...
impl CPU {
    fn execute(&mut self, op_code: u8) {
        match op_code {
            ...
            0xD3 => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            ...
            0xDB => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            0xDC => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            0xDD => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            ...
            0xE3 => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            0xE4 => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            ...
            0xEB => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            0xEC => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            0xED => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            ...
            0xF4 => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            ...
            0xFC => panic!("cpu: OP code not implemented {:#04X?}", op_code),
            0xFD => panic!("cpu: OP code not implemented {:#04X?}", op_code),
